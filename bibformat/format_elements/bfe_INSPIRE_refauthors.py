...
def format_element(bfo, limit, separator='; ',
    ...
    This version is for reference display of authors to satisfy the requirement that first name initials always be used.    
...
#For reference display authors we want the first and middle names as initials,
#so the Latex code is used.
